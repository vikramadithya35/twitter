...
<h1 style="position:absolute;top:0;left:40%;text-transform:uppercase;color:white;z-index:200;">likes</h1>
  
    <div style="position:fixed;top:0;left:0;width:100%;height:100px;background:white;opacity:0.7;"></div>
    <i class="fa fa-heart" aria-hidden="true" style="color:red;width:40px;z-index:105;position:fixed;top:38px;left:130px;font-size:40px;"></i>
...
$query="select * from likes where lname='$lname' and topic='$topic'";
...
while($row=mysqli_fetch_assoc($run)){
    ...
    echo "<a href='view.php?id=$id' style='text-decoration:none;'><h2 style='color:deepskyblue;margin:15px 0px 0px 80px;'>$fname</h2></a>";
